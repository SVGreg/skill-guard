...
func TestMaliciousFails(t *testing.T) {
	...
	want := map[string]bool{"SG-INJ-001": false, "SG-NET-002": false, "SG-SEC-001": false, "SG-NET-007": false, "SG-REF-003": false, "SG-DEP-007": false, "SG-CFG-001": false, "SG-MCP-001": false, "SG-DEP-008": false}
